...
export const metadata: Metadata = {
  title: "DMV Written Test 2026 — Free Practice for All 50 States",
  description: "Prepare for your DMV written test with free practice questions for all 50 states. Real exam-style questions with explanations. Updated for 2026.",
  alternates: { canonical: "https://dmv-prep.com/dmv-written-test" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">DMV Written Test 2026</h1>
          <p className="text-lg text-gray-600 mb-8">The DMV written test covers traffic laws, road signs, and safe driving rules. Our free practice questions mirror the real exam so you know exactly what to expect on test day.</p>
