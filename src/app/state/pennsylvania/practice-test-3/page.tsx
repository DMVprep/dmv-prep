...
export const metadata: Metadata = {
  title: "Pennsylvania DMV Practice Test 3 2026 — Free Pennsylvania Permit Questions",
  description: "Free Pennsylvania DMV practice test 3 with 25 real permit test questions. Traffic signs, right-of-way, speed limits, and safe driving.",
  alternates: { canonical: "https://dmv-prep.com/state/pennsylvania/practice-test-3" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 py-10">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Pennsylvania DMV Practice Test 3</h1>
