...
export const metadata: Metadata = {
  title: "Permit Test Practice 2026 — Free DMV Permit Practice Test",
  description: "Free permit test practice for all 50 states. Real DMV permit questions with explanations. Study traffic signs, right-of-way, speed limits. Pass your permit test first try.",
  alternates: { canonical: "https://dmv-prep.com/permit-test-practice" },
};
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-5xl mx-auto px-4 py-10">
          <h1 className="text-3xl font-bold text-gray-900 mb-3">Permit Test Practice 2026</h1>
          <p className="text-lg text-gray-600 mb-8">Preparing for your driver permit test? Our free permit test practice covers every topic on the real DMV exam — with explanations so you understand the rules, not just memorize answers.</p>
