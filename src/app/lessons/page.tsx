      ...
      <main className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-100 rounded-xl p-5 mb-4">
            <p className="text-base font-bold text-gray-900 mb-2">100 pages of rules, 15 minutes of reading.</p>
            <p className="text-sm text-gray-600 leading-relaxed mb-4">
              Other sites make you read the handbook over and over. We don&apos;t.
              Read each lesson <strong>once</strong>, then we take over &mdash; we quiz you on what you learned,
              bring back what you forgot, and tell you exactly when you are ready to pass.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="bg-white rounded-lg p-3 border border-green-100">
                ...
                <div className="text-sm font-semibold text-gray-900">We remind you</div>
                <div className="text-xs text-gray-500 mt-0.5">We send you the right questions every day. Just show up.</div>
              </div>
            </div>
          </div>
          ...
          {!isPaid && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-blue-600 mt-0.5">Unlock all lessons to be ready for your test</p>
              </div>
        ...
        <div className="mb-6 bg-purple-50 border border-purple-200 rounded-xl p-4 flex items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-gray-900">Don&apos;t know a word?</p>
              <p className="text-xs text-gray-600 mt-0.5">Search 108 driving terms explained in plain English. Perfect if English is not your first language.</p>
            </div>
          </div>
          <Link href="/vocabulary" className="bg-purple-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors flex-shrink-0 whitespace-nowrap">
            See vocabulary →
          </Link>
        </div>
