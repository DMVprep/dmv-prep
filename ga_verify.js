...
const CONCEPTS = {
  ...
  'speed:following':         { topic: TOPIC.SPEED,   pattern: /following.dist|2.second|two.second|one.thousand|tailgat/i },
  ...
  'alcohol:suspension':      { topic: TOPIC.ALCOHOL, pattern: /suspend.*DUI|DUI.*suspend|ALS/i },
  'alcohol:open-container':  { topic: TOPIC.ALCOHOL, pattern: /open container|alcohol.*vehicle/i },
  'license:permit':          { topic: TOPIC.LICENSE, pattern: /instructional permit|learner.?s? permit|class.*CP/i },
  'license:class-d':         { topic: TOPIC.LICENSE, pattern: /class.*D|provisional|restricted.*licens/i },
  ...
  'license:joshua-law':      { topic: TOPIC.LICENSE, pattern: /joshua.?s? law|30.*hour.*class|driver education.*30/i },
...
async function main() {
  console.log('=== GA FINAL VERIFICATION ===\n');
